...
- **Async (Message Bus)**: Event publishing/consuming voor notificaties:
  ...
  1. Redacteur keurt post goed/af in **Review Service**
  2. Review Service publiceert event naar **Message Bus**
  3. **Post Service** luistert naar event
  4. Post Service update status + stuurt notificatie
